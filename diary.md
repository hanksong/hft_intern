...
version1.1 : 减少无效对冲：定义cex价格偏移后回归，而dex基本不动为无效对冲。
  ...
  > ![1686834237170](image/diary/1686834237170.png)
  > ![1686834217936](image/diary/1686834217936.png)
...
四个时间段内，表现相对优秀的组合有$$(theta,pct) = \begin{cases}(30,10)\\(20,\_)\\(20,30)\end{cases}$$
